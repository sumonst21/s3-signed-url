...
def get_s3_signed_url(path, expire):
    ...
    signed_url = 'http://%s.s3.amazonaws.com/%s?AWSAccessKeyId=%s&Expires=%d&Signature=%s' % (bucket, obj, aws_access_key_id, expiry_ts, sig)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', '-p', help='The path of the s3 object (include S3 Bucket)')
    parser.add_argument('--time', '-t', help='Expiry time in second. Default: 1 hour')
